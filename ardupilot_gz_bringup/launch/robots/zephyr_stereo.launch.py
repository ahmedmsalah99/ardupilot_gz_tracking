...
"""
Launch a zephyr plane in Gazebo and Rviz.
...
defaults:=$(ros2 pkg prefix ardupilot_sitl)
          /share/ardupilot_sitl/config/default_params/gazebo-zephyr.parm,
...
def generate_launch_description():
    """Generate a launch description for a zypher plane."""
    ...
    sdf_file = os.path.join(
        pkg_ardupilot_gazebo, "models", "zephyr_stereo_with_ardupilot", "model.sdf"
    )
        ...
        parameters=[
            {
                "config_file": os.path.join(
                    pkg_project_bringup, "config", "zephyr_stereo_bridge.yaml"
                ),
